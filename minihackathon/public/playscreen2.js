  ...
  $.ajax({
    ...
    success: (data) => {
      ...
      if (data.player1.round1 >= 2) {
        ...
        for (var i = 2; i < data.player1.round1; i++) {
          console.log(i - 1)
          $("#score-round").append(`
                  <div class="row bg-light">
             <div class="col-sm">Round ${i}</div>
             <div class="col-sm">
               <input
                 class="form-control"
                 rows="1"
          ...
          document.getElementById(`point-1-round-${i}`).value = data.player1.point1[i - 1];
          document.getElementById(`point-2-round-${i}`).value = data.player2.point2[i - 1];
          document.getElementById(`point-3-round-${i}`).value = data.player3.point3[i - 1];
          document.getElementById(`point-4-round-${i}`).value = data.player4.point4[i - 1];
        }
        $("#score-round").append(`
                  <div class="row bg-light">
             ...
             <div class="col-sm">
               <input
                 class="form-control"
                 rows="1"
                id="point-1-round-${data.player1.round1}"
                 name="score"
               ></input> 
             </div>
             <div class="col-sm">
               <input
                 class="form-control"
                 rows="1"
                 id="point-2-round-${data.player1.round1}"
                 name="score"
               ></input>
             </div>
             <div class="col-sm">
               <input
                 class="form-control"
                 rows="1"
                 id="point-3-round-${data.player1.round1}"
                 name="score"
               ></input>
             </div>
             <div class="col-sm">
               <input
                 class="form-control"
                 rows="1"
                 id="point-4-round-${data.player1.round1}"
                 name="score"
               ></input>
             </div>
           </div>
                  `)
        document.getElementById(`point-1-round-${data.player1.round1}`).value = " ";
        document.getElementById(`point-2-round-${data.player1.round1}`).value = " ";
        document.getElementById(`point-3-round-${data.player1.round1}`).value = " ";
        document.getElementById(`point-4-round-${data.player1.round1}`).value = " ";
      }
